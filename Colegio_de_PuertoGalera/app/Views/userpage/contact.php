        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="cnt-info">
                        <h4>Contact Info</h4>
                        <p>Puerto Galera, Philippines, 5203</p>
                        <ul class="address">
                            <li><i class="fa fa-phone"></i>(043) 287 7067</li>
                            <!-- <li><i class="fa fa-phone"></i>+1 (2) 345 6789</li> -->
                            <li><i class="fa fa-envelope"></i>colegiodepuertogalera@gmail.com</li>
                        </ul>
                        <ul class="social list-inline mt-5">
                            <li><a href="https://web.facebook.com/colegiodepuertogalera"><i class="fa fa-facebook"></i></a></li>
                            <!-- <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-dribbble"></i></a></li>
                            <li><a href="#"><i class="fa fa-instagram"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                            <li><a href="#"><i class="fa fa-google-plus"></i></a></li> -->
                            <li><a href="https://youtu.be/4pRpPblXavk?si=iR5hcA9BrNudnIQM"><i class="fa fa-youtube"></i></a></li>
                            <!-- <li><a href="#"><i class="fa fa-skype"></i></a></li> -->
                        </ul>
                    </div>
                </div>
                <div class="col-lg-8">
                    <img src="assets/images/location.png" alt="Description of the image">
                </div>
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                ...
                <div class="cnt-title">
                    ...
                    <p>We'd love to hear from you! Feel free to reach out with any questions, comments, or inquiries. Our team is here to help.</p>
                </div>
            </div>
        </div>

        <div class="contact-form">  
            <form method="post" action="<?= site_url('/contact/sendEmail') ?>">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-12 text-center">
                        <button type="submit" name="submit">SEND TO US</button>
                    </div>
                </div>
            </form>
        </div>
...
<!-- contact form area end -->
    ...
    <script>
    // Add JavaScript to show modal when form is successfully submitted
    <?php if(session()->has('success')): ?>
